...
function createClient(model, context, apiKey, extraHeaders) {
    if (!apiKey) {
...
function buildParams(model, context, options) {
    const strictResponsesPairing = options?.strictResponsesPairing ??
...
function convertMessages(model, context, strictResponsesPairing) {
    const messages = [];
