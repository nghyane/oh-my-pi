 ...
 */
async function fetchMiniMaxCodeUsage(params, _ctx) {
...
export const minimaxCodeUsageProvider = {
    id: "minimax-code",
    fetchUsage: fetchMiniMaxCodeUsage,
    supports: (params) => (params.provider === "minimax-code" || params.provider === "minimax-code-cn") &&
