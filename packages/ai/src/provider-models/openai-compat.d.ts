...
export declare function opencodeModelManagerOptions(config?: OpenCodeModelManagerConfig): ModelManagerOptions<"openai-completions">;
export interface OllamaModelManagerConfig {
    apiKey?: string;
    baseUrl?: string;
}
export declare function ollamaModelManagerOptions(config?: OllamaModelManagerConfig): ModelManagerOptions<"openai-completions">;
