...
const AUTH_URL = "https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained";
 ...
 */
export async function loginHuggingface(options) {
    if (!options.onPrompt) {
