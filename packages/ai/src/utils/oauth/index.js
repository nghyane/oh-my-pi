...
const customOAuthProviders = new Map();
/**
 ...
 */
export function unregisterOAuthProviders(sourceId) {
...
function getPerplexityJwtExpiryMs(token) {
...
export async function getOAuthApiKey(provider, credentials) {
    ...
    if (provider === "perplexity") {
        const normalizedExpires = creds.expires > 0 && creds.expires < 10_000_000_000 ? creds.expires * 1000 : creds.expires;
