...
export class OAuthCallbackFlow {
    ...
    #callbackResolve;
    #callbackReject;
    constructor(ctrl, preferredPort, callbackPath = CALLBACK_PATH) {
        this.ctrl = ctrl;
     ...
     */
    #createServer(port, expectedState) {
        return Bun.serve({
     ...
     */
    #handleCallback(req, expectedState) {
        ...
        return new Response(templateHtml.replaceAll("__OAUTH_STATE__", JSON.stringify(resultState)), {
