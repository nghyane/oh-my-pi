import type { AssistantMessageEvent, AssistantMessageEventStream, ImageContent, Message, Model, SimpleStreamOptions, streamSimple, TextContent, Tool, ToolResultMessage } from "@oh-my-pi/pi-ai";
...
export type AgentToolUpdateCallback<T = any, TNormative extends TSchema = any> = (partialResult: AgentToolResult<T, TNormative>) => void;
